...
class CameraApp:
    def __init__(self, window, window_title, video_source=0, fps=30, x=0, y=0, scale=1.0):
        self.window = window
        ...
        self.btn_quit = tk.Button(window, text="Quit", command=window.quit)
        self.btn_quit.pack()
...
# Create a window and pass it to the CameraApp class with customizable position and scale factor
root = tk.Tk()
app = CameraApp(root, "Camera Feed", fps=10, x=200, y=100, scale=0.25)
