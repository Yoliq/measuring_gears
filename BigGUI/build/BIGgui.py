...
canvas.tag_bind(button_1_canvas, "<Button-1>", lambda event: on_button_press(event, button_1_canvas, button_1_pressed_photo, "Button 1"))
...
canvas.tag_bind(button_2_canvas, "<Button-1>", lambda event: on_button_press(event, button_2_canvas, button_2_pressed_photo, "Button 2"))
