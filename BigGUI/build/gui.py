...
def on_button_press(event, button_canvas, pressed_photo):
...
def on_button_release(event, button_canvas, photo, button_name):
    ...
    canvas.move(button_canvas, -4, -4)
    on_button_click(event, button_name)
...
canvas.tag_bind(button_1_canvas, "<Button-1>", lambda event: on_button_press(event, button_1_canvas, button_1_pressed_photo))
canvas.tag_bind(button_1_canvas, "<ButtonRelease-1>", lambda event: on_button_release(event, button_1_canvas, button_1_photo, "Button 1"))
...
canvas.tag_bind(button_2_canvas, "<Button-1>", lambda event: on_button_press(event, button_2_canvas, button_2_pressed_photo))
canvas.tag_bind(button_2_canvas, "<ButtonRelease-1>", lambda event: on_button_release(event, button_2_canvas, button_2_photo, "Button 2"))
...
canvas.tag_bind(button_3_canvas, "<Button-1>", lambda event: on_button_press(event, button_3_canvas, button_3_pressed_photo))
canvas.tag_bind(button_3_canvas, "<ButtonRelease-1>", lambda event: on_button_release(event, button_3_canvas, button_3_photo, "Button 3"))
...
canvas.tag_bind(button_4_canvas, "<Button-1>", lambda event: on_button_press(event, button_4_canvas, button_4_pressed_photo))
canvas.tag_bind(button_4_canvas, "<ButtonRelease-1>", lambda event: on_button_release(event, button_4_canvas, button_4_photo, "Button 4"))
...
canvas.tag_bind(button_5_canvas, "<Button-1>", lambda event: on_button_press(event, button_5_canvas, button_5_pressed_photo))
...
canvas.tag_bind(button_6_canvas, "<Button-1>", lambda event: on_button_press(event, button_6_canvas, button_6_pressed_photo))
...
image_10 = canvas.create_image(956.0, 324.0, image=image_image_10)
...
canvas.tag_bind(button_7_canvas, "<Button-1>", lambda event: on_button_press(event, button_7_canvas, button_7_pressed_photo))
...
canvas.tag_bind(button_8_canvas, "<Button-1>", lambda event: on_button_press(event, button_8_canvas, button_8_pressed_photo))
...
canvas.tag_bind(button_9_canvas, "<Button-1>", lambda event: on_button_press(event, button_9_canvas, button_9_pressed_photo))
...
canvas.tag_bind(button_10_canvas, "<Button-1>", lambda event: on_button_press(event, button_10_canvas, button_10_pressed_photo))
...
canvas.tag_bind(button_11_canvas, "<Button-1>", lambda event: on_button_press(event, button_11_canvas, button_11_pressed_photo))
